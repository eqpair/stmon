...
def format_stock_name(stock_code, base_name=None):
    ...
    stock_mapping = {
        ...
        '450140': '🔵 코오롱모빌리티그룹 [4.5 @ 2.2-0.1]',
        '004100': '🟢 태양금속 [5 @ 2.1-0.4]',
        '004250': '🔵 NPC [5 @ 2.0-0.4]',
        '001790': '🔵 대한제당 [5 @ 2.0-0.4]',
        '004830': '🟠 덕성 [5 @ 2.0-0.4]',
        '007810': '🔵 코리아써키트 [5 @ 2.0-0.4]',
        '002020': '🟠 코오롱 [5 @ 2.0-0.4]',
        '005380': '🔴 현대차 [0.5 @ 2.1-0.3]',
        '003540': '⚪ 대신증권 [5 @ 2.0-0.3]',
        '004980': '🟢 성신양회 [5 @ 2.0-0.4]',
        '003070': '🟢 코오롱글로벌 [5 @ 2.0-0.4]',
        '005940': '🟢 NH투자증권 [1 @ 2.0-0.3]',
        '019170': '🟢 신풍제약 [1.5 @ 2.0-0.4]',
        '066570': '⚪ LG전자 [0.5 @ 2.0-0.2]',
        '009830': '🟢 한화솔루션 [1 @ 2.1-0.3]',
        '004360': '⚪ 세방 [2.5 @ 2.0-0.4]',
        '003530': '🔵 한화투자증권 [5 @ 2.0-0.4]',
        ...
        '001510': '🟢 SK증권 [5 @ 2.0-0.4]',
        '071050': '🔵 한국금융지주 [1 @ 2.0-0.4]',
        '363280': '⚪ 티와이홀딩스 [5.25 @ 2.3-0.4]',
        '006800': '🔵 미래에셋증권 [0.5 @ 2.0-0.3]',
        '005960': '🔵 동부건설 [5 @ 2.0-0.4]',
        '264900': '🟢 크라운제과 [5 @ 2.2-0.2]',
        '000150': '🟢 두산 [0.25 @ 2.0-0.2]',
        '008350': '🟢 남선알미늄 [5 @ 2.1-0.4]',
        '011780': '🔵 금호석유 [0.5 @ 2.0-0.3]',
        '005720': '🔵 넥센 [5 @ 2.0-0.3]',
        '108670': '🟢 LX하우시스 [5 @ 2.0-0.3]',
        '000810': '🔴 삼성화재 [0.5 @ 2.0-0.4]',
        '084690': '🔵 대상홀딩스 [5 @ 2.0-0.3]',
        '285130': '🔵 SK케미칼 [1 @ 2.6-0.1]',
        '032680': '🔵 소프트센 [7 @ 2.0-0.3]',
        '009150': '⚪ 삼성전기 [0.5 @ 2.0-0.4]',
        '000320': '🟢 노루홀딩스 [2 @ 2.0-0.4]',
        '003550': '🔵 LG [0.5 @ 2.0-0.4]',
        '006400': '🔵 삼성SDI [0.5 @ 2.1-0.4]',
        '120110': '🟢 코오롱인더 [1 @ 2.0-0.4]',
        '006340': '🟢 대원전선 [5 @ 2.1-0.4]',
        '009410': '🔵 태영건설 [5 @ 2.0-0.3]',
        '000540': '🔵 흥국화재 [5 @ 2.0-0.4]',
        '021040': '🟢 대호특수강 [7 @ 2.1-0.3]',
        '012200': '🔵 계양전기 [5 @ 2.1-0.4]',
        '001750': '🟢 한양증권 [0.5 @ 2.0-0.3]',
        '008770': '🔴 호텔신라 [3 @ 2.0-0.4]',
        '096770': '🔴 SK이노베이션 [1 @ 2.0-0.3]',
        '004410': '🔴 서울식품 [5 @ 2.1-0.4]',
        '000720': '🟠 현대건설 [0.5 @ 2.2-0.4]',
        '375500': '🔴 DL이앤씨 [1 @ 2.1-0.4]',
        '078930': '🔵 GS [1 @ 2.1-0.4]',
        '014280': '🟢 금강공업 [5 @ 2.0-0.3]',
        '001680': '⚪ 대상 [1 @ 2.0-0.4]',
        '002990': '🔵 금호건설 [5 @ 2.1-0.3]',
        '097950': '🟠 CJ제일제당 [1 @ 2.0-0.3]',
        '006120': '🟠 SK디스커버리 [5 @ 2.0-0.3]',
        '000210': '🟢 DL [1 @ 2.0-0.4]',
        '090350': '🟢 노루페인트 [5 @ 2.2-0.4]',
        '001520': '🟢 동양 [2.5 @ 2.0-0.4]',
        '000880': '🔴 한화 [5 @ 2.0-0.4]',
        '001040': '🟠 CJ [1 @ 2.0-0.4]',
        '005740': '🟢 크라운해태홀딩스 [5 @ 2.1-0.3]',
        '005300': '🟢 롯데칠성 [1 @ 2.1-0.3]',
        '034730': '🔴 SK [0.5 @ 2.0-0.2]',
        '014910': '🔵 성문전자 [5 @ 2.0-0.4]',
        '007570': '🟢 일양약품 [5 @ 2.0-0.4]',
        '004990': '🟢 롯데지주 [1 @ 2.6-0.3]',
        '004540': '🔵 깨끗한나라 [1.5 @ 2.0-0.4]',
        '000100': '🔵 유한양행 [1 @ 2.0-0.3]',
        '001270': '🟠 부국증권 [5 @ 2.0-0.4]',
        '003920': '🟠 남양유업 [5 @ 2.0-0.4]',
        '003460': '🟢 유화증권 [5 @ 2.0-0.4]',
        '145990': '🔵 삼양사 [5 @ 2.3-0.4]',
        '001060': '🟢 JW중외제약 [5 @ 2.0-0.4]',
        '000140': '🟠 하이트진로홀딩스 [5 @ 2.0-0.3]',
        '001460': '🟠 BYC [0.5 @ 2.0-0.4]',
        '000070': '🟢 삼양홀딩스 [5 @ 2.0-0.3]',
